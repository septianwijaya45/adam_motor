<div class="wrapper">
  ...
  <nav id="sidebar">
    <div class="sidebar-header">
      <img src="<?= base_url('assets/img/img_properties/logo2.png'); ?>" alt="logo" class="img-fluid">
    </div>
        <?php 
    ...
    <ul class="list-unstyled components">
      ...
      <?php else: ?>
        <li>
      <?php endif ?>
        <a href="<?= base_url('main'); ?>"><i class="fa fa-home"></i> Dashboard</a>
      </li>
      ...
      <?php else: ?>
        <li>
      <?php endif ?>
        <a href="<?= base_url('transaksi'); ?>"><i class="fa fa-cart-plus"></i> Transaksi</a>
      </li>
      ...
      <li>
        ...
        <?php endif ?>
          <li>
            <a href="<?= base_url('main/outlet'); ?>"><i class="fa fa-wrench"></i>&ensp;Data Bengkel</a>
          </li>
          <?php if ($dataUser['jabatan'] == 'administrator'): ?>
            <li>
              <a href="<?= base_url('main/user'); ?>"><i class="fas fa-fw fa-user"></i>&ensp;User</a>
            </li>
          <?php endif ?>
          <li>
            <a href="<?= base_url('main/menu'); ?>"><i class="fa fa-motorcycle"></i>&ensp;Data Barang</a>
          </li>
        </ul>
      </li>
      ...
      <?php if ($className == 'returnbarang'): ?>
        <li class="active">
      <?php else: ?>
        <li>
      <?php endif ?>
        <a href="<?= base_url('returnbarang'); ?>"><i class="fas fa-undo"></i> Return Barang</a>
      </li>
      <li>
        ...
        <?php endif ?>
          ...
          <li>
            <a href="<?= base_url('laporanKeuangan'); ?>">Laporan Keuangan</a>
          </li>
          <li>
      ...
      <li>
        ...
        <?php else: ?>
          <a href="#homeSubmenu3" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fas fa-fw fa-file-signature"></i>Aktivitas</a>
    ...
    <ul class="list-unstyled">
        <p>Copyright 2022 &copy; By Syehzadi Anggita. All Right Reserved.</p>
      </li>
    </ul>
  </nav>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <button type="button" id="sidebarCollapse" class="btn merah-baru">
          <i class="fas fa-align-left"></i> | Selamat Datang <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>di Website Adam Motor</a>
