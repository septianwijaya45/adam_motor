<div class="container">
	<div class="row my-2">
		<div class="col-lg my-2 py-2 header-title">
			<h3><i class="fa fa-motorcycle"></i> Daftar Barang</h3>
		</div>
				    ...
				    <form action="<?= base_url('main/addMenu'); ?>" method="post">
				    	<div class="modal-content text-left">
					      <div class="modal-header">
					        <h5 class="modal-title" id="tambahMenuModalLabel"><i class="fas fa-fw fa-utensils"></i><sup><i class="fas fa-1x fa-plus"></i></sup> Tambah Barang</h5>
					      ...
					      <div class="modal-body">
					      	...
					      	<div class="form-group">
					      		<label for="harga_menu">Harga Barang</label>
